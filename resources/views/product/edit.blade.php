    ...
    <form method="POST" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" id="title"
                   aria-describedby="emailHelp" placeholder="Enter title" value="{{$product->title}}">
            @if($errors->has('title'))
        ...
        <div class="form-group">
            ...
            <input type="number" name="total_count" class="form-control" id="total_count" value="{{$product->total_count}}" >
